...
function Messi(data, options) {
  ...
  if (_this.options.buttons.length > 0) {
    for (var i = 0; i < _this.options.buttons.length; i++) {
      var cls = _this.options.buttons[i]["class"]
        ? _this.options.buttons[i]["class"]
        : "";
      var btn = jQuery(
        '<div class="btnbox"><button class="btn ' +
          cls +
          '" href="#">' +
          _this.options.buttons[i].label +
          "</button></div>"
  ...
  if (
    _this.options.buttons.length === 0 &&
    _this.options.title == null &&
  ...
  _this.modal = _this.options.modal
    ? jQuery('<div class="messi-modal"></div>')
        .css({
...
Messi.prototype = {
  ...
  template:
    '<div class="messi"><div class="messi-box"><div class="messi-wrapper"><div class="messi-titlebox"><span class="messi-title"></span></div><div class="messi-content"></div><div class="messi-footbox"><div class="messi-actions"></div></div></div></div></div>',
  content: "<div></div>",
  visible: false,

  setContent: function (data) {
    jQuery(".messi-content", this.messi)
      .css({ padding: this.options.padding, height: this.options.height })
      .empty()
      .append(data);
  },
  ...
  viewport: function () {
    return {
      top:
        (jQuery(window).height() - this.messi.height()) / 2 +
        jQuery(window).scrollTop() +
        "px",
      left:
        (jQuery(window).width() - this.messi.width()) / 2 +
