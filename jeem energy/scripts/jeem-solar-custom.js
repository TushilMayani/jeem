...
$(".button-active").on("click", function () {
  ...
  setTimeout(function () {
    $(
      ".cls-405, .cls-401, .cls-373, .cls-371, .cls-368, .cls-358, .cls-360"
    ).toggleClass("window-highligh");
    $(".cls-334, .cls-331, .cls-332, .cls-333, .cls-334, .cls-335").toggleClass(
      "d-none"
    );
  }, 500);
});
...
$(".home-miletone .row").each(function () {
  ...
  if (LiN > 4) {
    ...
    $(this).append(
      '<div class="more w-100 text-center">View more<em class="fa fa-chevron-down ml-2"></em></div>'
    );
  }
});
$(".home-miletone .row").on("click", ".more", function () {
  if ($(this).hasClass("less")) {
    $(this)
      .text("View More")
      .append('<em class="fa fa-chevron-down ml-2"></em>')
      .removeClass("less");
  } else {
    $(this)
      .text("View less")
      .append('<em class="fa fa-chevron-up ml-2"></em>')
      .addClass("less");
  }
...
$(document).ready(function () {
  if (window.location.href.indexOf("#2") > 0) {
    $("html, body").animate(
      {
        scrollTop: $("#2").offset().top - 130,
      },
      1000
    );
    $("#collapse-2").toggleClass("show");
  }
  /*1st Section*/
  if (window.location.href.indexOf("#3") > 0) {
    $("html, body").animate(
      {
        scrollTop: $("#3").offset().top - 130,
      },
      1000
    );
    $("#collapse-3").toggleClass("show");
  }
  /*2nd Section*/
  if (window.location.href.indexOf("#4") > 0) {
    $("html, body").animate(
      {
        scrollTop: $("#4").offset().top - 130,
      },
      1000
    );
    $("#collapse-4").toggleClass("show");
  }
  /*3rd Section*/
  if (window.location.href.indexOf("#5") > 0) {
    $("html, body").animate(
      {
        scrollTop: $("#5").offset().top - 130,
      },
      1000
    );
    $("#collapse-5").toggleClass("show");
  }
  /*4th Section*/
});
