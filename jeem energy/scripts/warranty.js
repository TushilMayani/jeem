...
$(function () {
  ...
  $(document).mouseup(function (e) {
    ...
    if (
      $(e.target).parents(".blocking-span input").length == 0 &&
      !$(e.target).is(".blocking-span input")
    ) {
...
var countryData = window.intlTelInputGlobals.getCountryData(),
  input = document.querySelector(
    "#fxb_3d39bc0e-acd7-4914-a076-05e30425192e_Fields_9e2d6f45-40ef-459f-8590-18b13e76ee6c__Value"
  ),
